...
@Entity
@Table(name = "users") //nome igual ao utilizado nas migrations
public class User implements UserDetails, Serializable{
	...
	@Column(name = "full_name") //essa propriedade não faz parte do core para autenticação
	...
	@ManyToMany(fetch = FetchType.EAGER) //mapeamento da user_permission
	@JoinTable(name = "user_permission", joinColumns = {@JoinColumn (name = "id_user")},
		inverseJoinColumns = {@JoinColumn (name = "id_permission")})
	private List<Permission> permissions; //lista de permissões
	
	public User() {} // atender condições do JPA

	public List<String> getRoles() { //implementado por convenção
